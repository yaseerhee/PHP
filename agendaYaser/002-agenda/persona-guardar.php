...
if ($nueva_entrada) {
    ...
    $sql = "INSERT INTO persona (nombre,apellidos,telefono,categoria_id,estrella) VALUES (?,?,?,?)";
    $parametros = [$nombre, $apellido, $telefono, $categoria_id, $estrella];
} else {
    // Quieren MODIFICAR una categoría existente y es un UPDATE.
    $sql = "UPDATE persona SET nombre=?, apellidos=?, telefono=? ,categoria_id=?, estrella=? WHERE id=?";
    $parametros = [$nombre, $apellido, $telefono, $categoria_id, $estrella, $id];
}
...
<body>
    <div>
        ...
        ?>
            ...
            <p>No se han podido guardar los datos de la personas.</p>
